        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (intent.getScheme().equals("com.snowsea.accountingtutors.payments")) {
            // Uri i = intent.getData();
            // String checkoutId = intent.getData().getQueryParameter("id");
            // String checkoutId = "";
            // Log.e("______SNOWSEA______", checkoutId);
            DataManager.getManager(this).getCheckoutStatus(fragPurchase.checkoutID, fragPurchase);
