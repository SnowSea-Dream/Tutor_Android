            ...
            public void onClick(View v) {
                ...
                DataManager.getManager(activity).getCheckoutID(subject.getPrice(), new DataManager.PurchaseDelegate() {
                    ...
                    public void handleResponse(PurchaseInfo response) {
                        ...
                        Log.e("SNOWSEA_CHECKOUT", checkoutID);
                        Set<String> paymentBrands = new LinkedHashSet<String>();

                        paymentBrands.add("VISA");
                        paymentBrands.add("MASTER");

                        CheckoutSettings checkoutSettings = new CheckoutSettings(response.getId(), paymentBrands, Connect.ProviderMode.LIVE);
//                        checkoutSettings.setWebViewEnabledFor3DSecure(true);
//                        Intent intent = new Intent(activity, CheckoutActivity.class);
                        Intent intent = checkoutSettings.createCheckoutActivityIntent(activity);
